...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/articles', name: 'articles', component: () => import('@/views/public/ArticlesView.vue'), meta: { layout: 'public', title: 'Artikel' } },
  { path: '/articles/:id', name: 'article-detail', component: () => import('@/views/public/ArticleDetailView.vue'), meta: { layout: 'public', title: 'Detail Artikel' } },
